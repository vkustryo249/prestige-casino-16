...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-1c47f402');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-1c47f402');}
...
var brandEl=document.querySelector('.rl-brand-1c47f402');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
